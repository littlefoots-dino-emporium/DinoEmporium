...
namespace DinoEmporium.Controllers.CustomerProductController
{
    ...
    public class CustomerProductController : ControllerBase
    {
        ...
        [HttpDelete("deleteCustomerProduct/{productId}")]
        public ActionResult DeleteCustomerProduct(int productId)
        {
            var deleteCustomerProduct = _customerProductRepository.DeleteSingleCustomerProduct(productId);
            return Ok(deleteCustomerProduct);
        }

        [HttpDelete("deleteCart/{customerId}")]
        public ActionResult DeleteAllCustomerProduct(int customerId)
        {
            var deleteAllCustomerProduct = _customerProductRepository.DeleteAllCustomerProduct(customerId);
